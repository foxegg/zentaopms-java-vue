...
/** 与 PHP gitlab 一致：zt_repo scm=gitlab；create/edit/delete 对接 RepoService */
@RestController
@RequestMapping("/api/gitlab")
@RequiredArgsConstructor
public class GitlabController {

    private static final String SCM_GITLAB = "gitlab";
