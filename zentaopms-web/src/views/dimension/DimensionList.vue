      ...
      <table class="data-table">
        ...
        <tbody>
          <tr v-for="d in list" :key="d.id">
            <td>{{ d.id }}</td>
            <td>{{ d.name }}</td>
            <td><router-link :to="`/dimension/${d.id}`" class="btn">{{ commonLang.view }}</router-link></td>
          </tr>
        </tbody>
      </table>
...
import { common as commonLang, dimension as dimensionLang } from '@/lang/zh-cn'
